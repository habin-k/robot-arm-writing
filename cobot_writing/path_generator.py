...
FONT_PATHS = {
    'regular':      str(_FONT_DIR / 'Helvetica Extended Medium.ttf'),
    'bold':         str(_FONT_DIR / 'Helvetica Bold.ttf'),
    'light':        str(_FONT_DIR / 'Helvetica Light.ttf'),
    'condensed':    str(_FONT_DIR / 'Helvetica Condensed.ttf'),
    'extended':     str(_FONT_DIR / 'Helvetica Extended.ttf'),
    'brother':      str(_FONT_DIR / 'Brother Signature.otf'),
    'sansbold':     str(_FONT_DIR / 'GmarketSansBold.otf'),
    'sanslight':    str(_FONT_DIR / 'GmarketSansLight.otf'),
    'sansmedium':   str(_FONT_DIR / 'GmarketSansMedium.otf'),
    'griun_cherri': str(_FONT_DIR / 'Griun_Cherry1Spoon-Rg.ttf')
}
