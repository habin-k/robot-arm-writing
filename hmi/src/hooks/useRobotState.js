...
// /ws/robot 구독: 로봇 실시간 상태(User_102·BASE 좌표·외력 + 종이 감지)
export const useRobotState = () => {
  const [robot, setRobot] = useState({
    tcp_position: [0, 0, 0, 0, 0, 0],       // User_102 좌표
    tcp_force: [0, 0, 0, 0, 0, 0],          // User_102 외력
    tcp_position_base: [0, 0, 0, 0, 0, 0],  // BASE 좌표
    tcp_force_base: [0, 0, 0, 0, 0, 0],     // BASE 외력
